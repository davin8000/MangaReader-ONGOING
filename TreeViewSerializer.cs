...
namespace TreeViewSerialization
{
    ...
    public class TreeViewSerializer
    {
        ...
        private const string XmlNodeisExpandedAtt = "exp";
        private const string XmlNodeisSelectededAtt = "sel";
        ...
        private void SaveNodes(TreeNodeCollection nodesCollection, XmlTextWriter textWriter)
        {
            for (int i = 0; i < nodesCollection.Count; i++)
            {
                ...
                textWriter.WriteAttributeString(XmlNodeisExpandedAtt, node.IsExpanded.ToString());
                textWriter.WriteAttributeString(XmlNodeisSelectededAtt, node.IsSelected.ToString());
        ...
        private void SetAttributeValue(TreeNode node, string propertyName, string value)
        {
            ...
            else if (propertyName == XmlNodeisExpandedAtt)
            {
                if (bool.Parse(value)) node.Expand();
            }
        }
